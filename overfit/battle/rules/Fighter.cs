...
public sealed class Fighter
{
    ...
    /// 때문이다: 디버그 읽기 <c>Battle.FighterComboStep</c>(셔터가 2타를 노린다)는 아무 때나 묻고, <see cref="AttackDamage"/> 는
    /// "다음에 누르면 휘두를 칼" 을 말한다(FighterActionTests 의 "2타 뒤에는 이어 칠 것이 없다" 가 끝난 뒤의 0 을 본다). 안 지우면
    /// 서 있는 파이터가 끝난 2타를 지금 칼로 말한다.
    ///
    /// <para>
