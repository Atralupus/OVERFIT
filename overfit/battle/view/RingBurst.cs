...
/// <summary>
/// 원과 스파크를 그리는 이펙트 노드 하나. 파이터의 패리 링과 보스의 선딜 예고·판정 충격파가
/// <b>같은 그림</b>이라 한 클래스로 둔다 — 크기와 색만 부르는 쪽이 정한다.
///
/// <para>
/// 두 가지 모드가 있다.
/// <list type="bullet">
/// <item><see cref="Charge"/> — <b>프레임마다 다시 준다.</b> 창이 열려 있는 동안의 링이고,
/// 반지름이 곧 "얼마나 남았나" 다. 안 주는 프레임엔 <b>저절로 사라진다</b> —
/// 끄는 메서드를 일부러 안 만들었다. 끄는 것을 잊어 링이 남는 사고를 구조로 없앤다.</item>
/// <item><see cref="Burst"/> — <b>한 번 주면 스스로 끝난다.</b> 성공·판정 같은 순간이다.</item>
/// </list>
