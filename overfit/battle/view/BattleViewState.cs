...
/// <param name="Stiff">행동 뒤 경직 중인가 (#82) — 칼질(<see cref="FighterPose.Attack"/>)이면 그 시트의 마지막 장을, 대시
/// (<see cref="FighterPose.Dash"/>)면 대시의 마지막 자세를 붙든다. 자세는 그대로라(경직도 그 행동이다) 이것이 따로 온다.</param>
