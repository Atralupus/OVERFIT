...
///
/// <para>
/// <b>왜 색이 아니라 기호인가.</b> 이 게임의 붉은색은 이미 <b>반대 뜻</b>으로 차 있다 —
/// 크림슨은 "패리 불가 · 대시해라"(이슈 #27)인데 가드 불가는 "<b>받아쳐라</b>" 다.
/// 둘 다 붉게 두면 플레이어는 정확히 거꾸로 반응한다. 그래서 링은 평소대로 호박색으로 두고
/// 그 위에 글자 하나를 얹는다: <b>색은 "얼마나 위험한가" 를 말하고 기호는 "무엇을 하라" 를 말한다.</b>
/// </para>
///
/// <para>
...
public static class GuardBreakMark
{
    ...
    /// <summary>글자 뒤 판의 색. 링과 같은 호박색 계열이되 <b>어둡다</b> — 판이 밝으면 글자가 묻힌다.</summary>
