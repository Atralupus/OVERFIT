...
public partial class ShotRunner : Node
{
    ...
    ///
    /// <para>
    /// <b>새 판에서, 벽까지 물러나 찍는다.</b> 최대 차지는 2.4초를 서 있어야 하는데 백장의 빈 시간은
    /// 그보다 짧아서(fighters.json 의 _note_charge) 교전 거리에서는 거의 언제나 맞아 끊긴다 —
    /// 그건 이 기술의 설계지 그림의 실패가 아니고, <b>설계는 테스트가 증명하고 그림은 스크린샷이
    /// 증명한다.</b> 사거리 밖으로 나가면 둘을 섞지 않고 그림만 볼 수 있다.
    /// </para>
    /// </summary>
