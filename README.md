...
**점프 공격의 착지는 흰 충격파다.** 착지의 판정은 칼 궤적이 아니라 바닥의 띠라서, 그 띠를 그린다 — 착지한 발밑에서
흰 띠가 바닥을 따라 양옆으로 퍼진다. 띠의 높이는 규칙이 치는 판정의 높이 그대로라, 보이는 띠 위로 뛴 발은 안 맞는다.
...
| 착지 — 발밑에서 흰 충격파가 바닥을 따라 양옆으로 퍼진다. 띠의 높이가 곧 맞는 높이라, 뛰어오른 파이터는 그 위에 떠 있다 | 2단계의 결과 화면 — 1단계를 이기면 2단계가 선다 |
