...
그래서 최대 차지는 칼이 닿기까지 2.08초다 — 백장의 패턴 사이(1.90~2.40초)에 대개 들어간다.

안 들어가는 것은 다음 패턴이 `내려찍기 3연` 일 때뿐이다. 그게 이 기술의 도박인데 눈감고 하는
도박은 아니다 — 다음 예고는 최대에 닿기 0.5초 전에 서므로, **끌리는 칼을 보면 놓아서 두 배로 바꾼다.**
